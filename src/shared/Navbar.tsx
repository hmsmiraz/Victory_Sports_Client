            ...
            <div className="flex-1 flex lg:justify-start md:justify-center justify-start lg:order-1 order-3 lg:col-span-1 sm:col-span-2 md:bg-black lg:bg-transparent md:rounded-full md:text-white lg:text-black py-2">
              ...
              <div className="md:hidden visible">
                <Drawer direction="left">
                  ...
                  <DrawerContent>
                    <NavigationMenu>
                      <NavigationMenuList className="font-semibold flex-col text-left">
                        <NavigationMenuItem className="w-full">
                          ...
                          >
                            <img
                              src="https://i.ibb.co/P5hYr34/Victory-Sports-Logo-2.png"
                              alt="logo"
                              className="w-32"
                            />
                          </NavLink>
            ...
            <div className="flex-1 flex justify-end order-3 md:order-2 ">
              <NavigationMenu>
                <NavigationMenuList className="font-semibold">
                  ...
                  <NavigationMenuItem className="relative"></NavigationMenuItem>
