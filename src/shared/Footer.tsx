...
const Footer = () => {
  return (
    <div>
      <div className="w-full bg-black text-gray-300 py-14">
        <div className="container">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 lg:px-0 md:px-10 px-5">
            <div className="relative">
              ...
              <p className="mt-5">Welcome to Victory Sporting Shops</p>
            ...
            <div className="relative">
              ...
              <div className="mt-5">
                ...
                <p>
                  Subscribe for our newsletter and stay up-to-date with the
                  latest collection!
                </p>
